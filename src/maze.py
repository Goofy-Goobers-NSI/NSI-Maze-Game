...
DX = {E: 1, W: -1, N: 0, S: 0}  # EAST/WEST move by (x+1,y+0) or (x-1, y+0), basically move right/left
DY = {E: 0, W: 0, N: -1, S: 1}  # NORTH/SOUTH move by (x+0, y-1) or (x+0, y+1), move up/down
